...
public class Erosion implements IBaseInPlace{
    ...
    /**
     * Initialize a new instance of the Erosion class with radius = 1.
     */
    public Erosion() {
        this.radius = 1;
    }
    ...
    /**
     * Initialize a new instance of the Erosion class with structuring element.
     * @param se Structuring element.
     */
    public Erosion(int[][] se) {
        this.kernel = se;
    }

    /**
     * Initialize a new instance of the Erosion class with defined.
     * @param radius Radius
     */
